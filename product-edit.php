...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
  ...
  <body>
	...
	<?php
	 ...
	 $sql = "select * from product where productcode like '%$id%'\n";
      ...
      <div class="row">
		...
		<div class="col-6">
		    <div class="form-group">
				...
				<input type="text" class="form-control lead"  name="productcode" value="<?=$row['productcode'];?>" style="text-align:center">
			</div>
			<form name="update" method="post" action="process-updateproduct.php?id=<?php echo $id;?>">
				<div class="form-group">
					<label for="name" class="lead">Name/Description</label>
					<input type="text" class="form-control" name="name" style="text-transform:uppercase;text-align:center" value="<?=$row['name'];?>" required>
				</div>
				<div class="form-group">
					<label for="price" class="lead">Price</label>
					<input type="text" class="form-control" name="price" style="text-transform:uppercase;text-align:center" value="<?=$row['price'];?>" required>
				</div>
				<p align="right"><a href="product-details.php"  class="btn btn-danger btn-lg" >Cancel</a>
